...
while ($row = pg_fetch_assoc($handle)) {
    ...
    if ($row['tc'] == 0) // if tag is unused, display link for deletion
        echo "<td><strong><a href=\"./forms/tag_delete.php?tag=".$row['tag_id']."\">slett</a></strong></td>";
    else
        echo "<td><a href=\"./tag_view.php?tag=".$row['tag_id']."\">rapport</a></td>";
